                ...
                <div className="p-6">
                  <div className="flex items-center mb-6">
                    <div className="relative w-16 h-16 rounded-full overflow-hidden mr-4">
                      ...
                      <Image 
                        src="https://market-resized.envatousercontent.com/photodune.net/EVA/TRX/e5/55/17/13/bb/v1_E10/E108D611.jpg?auto=format&q=94&mark=https%3A%2F%2Fassets.market-storefront.envato-static.com%2Fwatermarks%2Fphoto-260724.png&opacity=0.2&cf_fit=contain&w=590&h=393&s=7d0ec7047f07ea381f7cd4ebd325b1bf9dc33b98d985e4a86676aae84a0a5e1a" 
                        alt="Rajesh Sharma" 
                        fill
                    ...
                    <div>
                      <h3 className="font-bold text-lg text-slate-800">Rajesh Sharma</h3>
                ...
                <div className="p-6">
                  <div className="flex items-center mb-6">
                    <div className="relative w-16 h-16 rounded-full overflow-hidden mr-4">
                      <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/20 to-transparent z-10"></div>
                      <Image 
                        src="https://thumbs.dreamstime.com/b/young-indian-business-woman-entrepreneur-looking-camera-office-shot-young-indian-business-women-entrepreneur-looking-170375838.jpg" 
                        alt="Priya Patel" 
                        fill
                        className="object-cover"
                      />
                    ...
                    <div>
                      <h3 className="font-bold text-lg text-slate-800">Priya Patel</h3>
                ...
                <div className="p-6">
                  <div className="flex items-center mb-6">
                    <div className="relative w-16 h-16 rounded-full overflow-hidden mr-4">
                      <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/20 to-transparent z-10"></div>
                      <Image 
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTYSZHZz_nRy5aVnDWNfL1imBQaGeLKVOweZQ&s" 
                        alt="Vikram Mehta" 
                        fill
                        className="object-cover"
                      />
                    ...
                    <div>
                      <h3 className="font-bold text-lg text-slate-800">Vikram Mehta</h3>
