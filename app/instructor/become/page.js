  ...
  return (
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="mb-6">
          <h2 className="text-xl font-semibold mb-4">Instructor Application</h2>
          <p className="text-gray-600">
            Thank you for your interest in becoming an instructor at JedMantra. Please complete the form below to apply.
        ...
        {submitSuccess ? (
          <div className="bg-green-50 border border-green-200 text-green-700 p-4 rounded-md mb-6">
            ...
            <p>Thank you for applying to become an instructor. We'll review your application and contact you soon.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-2 border rounded-md focus:ring-blue-500 focus:border-blue-500 ${errors.expertise ? 'border-red-500' : 'border-gray-300'}`}
                >
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="3"
                placeholder="Describe your teaching experience, including years of experience, institutions, etc."
                className={`w-full px-4 py-2 border rounded-md focus:ring-blue-500 focus:border-blue-500 ${errors.experience ? 'border-red-500' : 'border-gray-300'}`}
              ></textarea>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="3"
                placeholder="List relevant degrees, certifications, or qualifications"
                className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
              ></textarea>
            </div>
            ...
            <div>
              <label htmlFor="motivation" className="block text-sm font-medium text-gray-700 mb-1">
                Why do you want to teach on JedMantra? <span className="text-red-500">*</span>
              </label>
              <textarea
                id="motivation"
                name="motivation"
                ...
                onChange={handleChange}
                rows="4"
                placeholder="Tell us why you're passionate about teaching and what you hope to achieve as an instructor"
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-700">
            ...
            <li>You'll set up your instructor profile and onboarding</li>
            <li>Start creating your first course with our support</li>
          </ol>
        </div>
      </div>
    </div>
