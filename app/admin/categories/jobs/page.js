...
export default function JobCategories() {
  ...
  const createCategoriesTable = async () => {
    try {
      ...
      const { error } = await supabase.rpc('create_job_categories_table');
      ...
      <div className="bg-gradient-to-r from-green-600 to-green-700 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-white">Job Categories</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {!loading && (
          <div className="bg-white shadow-sm rounded-lg overflow-hidden">
            <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
              <h3 className="text-lg leading-6 font-medium text-gray-900">Job Categories</h3>
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
